...
(function(){
  ...
  aboutOstBackBtn.addEventListener("click",()=>{
    hide(aboutOstCard);
    // Return to main by default; if you want, this could remember where you came from.
    goMain();
  });
  ...
  // Simple FRAT item set, aligned with pilot / aircraft / environment / external pressures.
  // rule: "BOTH", "VFR", or "IFR"
  const FRAT_ITEMS=[
